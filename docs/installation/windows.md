...
<div class="text-center mb-3">
  <a class="btn btn-primary text-center" href="https://github.com/ecker-lab/SiLVi/releases/download/v0.5.3-alpha/SiLVi-0.5.3.Setup.exe" role="button"><i class="bi bi-windows"></i> Download for Windows</a>
</div>
